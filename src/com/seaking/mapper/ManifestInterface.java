...
public interface ManifestInterface {
	 ...
	 * @param p
	 */
	public abstract void addProvider(Provider p);
	
	/**
	 * 
	 * @return the Content Providers
	 */
	public abstract Collection<Provider> getProviders();
	...
	public void setDefaultActivity(ActivityInterface activity)
			throws com.seaking.datamodel.DuplicateEntryPointException;
