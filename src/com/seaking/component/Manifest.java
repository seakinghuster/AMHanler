...
import com.seaking.datamodel.DuplicateEntryPointException;
import com.seaking.mapper.ActivityInterface;
import com.seaking.mapper.ComponentInterface;
...
public class Manifest implements ManifestInterface {
    ...
    private boolean appAllowBackup = true; //Ä¬ÈÏÎªTRUE
	...
	public List<ComponentInterface> getComponents() {
		...
		components.addAll(this.providers.values());
		return components;
	}
	...
	public boolean hasPermission(String perm) {
		return permissions.contains(new Permission(perm));
	}

	@Override
	public void setAppAllowBackup(boolean appAllowBackup) {
